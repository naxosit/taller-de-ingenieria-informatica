...
// Obtener lista de cines para el select
$cines = [];
try {
    $query = "SELECT idCine, Nombre FROM Cine ORDER BY Nombre";
...
<body>
    <header class="header">
        ...
        <nav>
            <a href="../vista_sala.php">Lista de Salas</a>
            ...
            <form id="form-sala" action="guardar_sala.php" method="POST">
                <table class="form-table">
                    <tr>
                        ...
                        <td><input type="text" id="nombre" name="nombre" required class="form-input" maxlength="100"></td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2" style="text-align: center;">
                            <button type="submit" class="btn-submit">Guardar Sala</button>
                        </td>
                    </tr>
                </table>
            </form>
